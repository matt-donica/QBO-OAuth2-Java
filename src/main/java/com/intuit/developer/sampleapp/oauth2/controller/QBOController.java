...
public class QBOController {
    ...
    public String callQBOCustomerInfo(HttpSession session) {
        ...
        String customerInfoEndpoint = String.format("%s/v3/company/%s/customer/%s", oAuth2Configuration.getAccountingAPIHost(), realmId, 58);

        String failureMsg="Failed";

        HttpGet companyInfoReq = new HttpGet(customerInfoEndpoint);
    ...
    @ResponseBody
    @RequestMapping(value = "/QBOCustomers/")
    public String QBOCustomers(HttpSession session) {
        ...
        String customerInfoEndpoint = String.format("%s/v3/company/%s/query?query=%s", oAuth2Configuration.getAccountingAPIHost(), realmId, "select%20%2a%20from%20Customer");
    ...
    @ResponseBody
    @RequestMapping(value = "/QBOInvoices/")
    public String QBOInvoices(HttpSession session) {
        ...
        String customerInfoEndpoint = String.format("%s/v3/company/%s/query?query=%s", oAuth2Configuration.getAccountingAPIHost(), realmId, "select%20%2a%20from%20Invoice");
    ...
    @ResponseBody
    @RequestMapping(value = "/QBOItems/")
    public String QBOItems(HttpSession session) {
        ...
        String customerInfoEndpoint = String.format("%s/v3/company/%s/query?query=%s", oAuth2Configuration.getAccountingAPIHost(), realmId, "select%20%2a%20from%20Item");
